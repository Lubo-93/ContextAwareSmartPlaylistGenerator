...
public class GeofenceRequester implements
    ...
    public void onAddGeofencesResult(int statusCode, String[] geofenceRequestIds) {
        ...
        if (LocationStatusCodes.SUCCESS == statusCode) {
            ...
            broadcastIntent.setAction(AppParams.ACTION_GEOFENCES_ADDED)
                    .addCategory(AppParams.CATEGORY_CONTEXT_ANALYSIS)
    ...
    public void onConnectionFailed(ConnectionResult connectionResult) {
        ...
        mInProgress = false;
        Message status;
        // Try resolving an error using Google Play services
         ...
         */
            ...
            errorBroadcastIntent.addCategory(AppParams.CATEGORY_CONTEXT_ANALYSIS).putExtra(AppParams.EXTRA_CONNECTION_ERROR_CODE,
